...
ini_open(working_directory + "saveData.ini"); //tava com \\saveData.ini
    ...
    var p = 1; while (p <= 2)
    {
		...
		global.weapon1_modId[p] = ini_read_real("Character","ModWeapon1IdPlayer"+string(p),0);
		global.weapon2_isMod[p] = ini_read_real("Character","IsModWeapon2Player"+string(p),false);
		global.weapon2_modId[p] = ini_read_real("Character","ModWeapon2IdPlayer"+string(p),0);
