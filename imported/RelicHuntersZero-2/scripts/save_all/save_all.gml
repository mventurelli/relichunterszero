...
ini_open(working_directory + "\\saveData.ini");
	...
	ini_write_real("Temp","Scrap Endless",global.scrapEndless);
    ...
    while (p <= global.playerCount)
    {
        ...
        if (curPlayer) && instance_exists(curPlayer)
        {
            ...
            if instance_exists(curPlayer.weapon1)
            {
				...
				ini_write_real("Character","IsModWeapon1Player"+string(playerId),curPlayer.weapon1.isMod);
				ini_write_real("Character","ModWeapon1IdPlayer"+string(playerId),curPlayer.weapon1.ugcItemId);
            ...
            if instance_exists(curPlayer.weapon2)
            {
				...
				ini_write_real("Character","IsModWeapon2Player"+string(playerId),curPlayer.weapon2.isMod);
				ini_write_real("Character","ModWeapon2IdPlayer"+string(playerId),curPlayer.weapon2.ugcItemId);
	...
	ini_write_real("Mapping","Keyboard Recycle1",global.inputRecycle1);
	ini_write_real("Mapping","Keyboard Recycle2",global.inputRecycle2);
