///ds_grid_get_left(grid,x,y)
// Returns the best possible value to the left of the indicated coordinates, or return -1
...
//Go straight left
for (var i=myX-1; abs(i)<ds_grid_width(myGrid); i--)
{
