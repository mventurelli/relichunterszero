...
draw_text_transformed(tX+shadowDistance,tY+shadowDistance,string_hash_to_newline(text),xScale,yScale,myRotation);

// Outline
draw_set_color(outlineColor);
draw_text_transformed(tX+1,tY+1,string_hash_to_newline(text),xScale,yScale,myRotation);
draw_text_transformed(tX-1,tY-1,string_hash_to_newline(text),xScale,yScale,myRotation);
draw_text_transformed(tX,tY+1,string_hash_to_newline(text),xScale,yScale,myRotation);
draw_text_transformed(tX+1,tY,string_hash_to_newline(text),xScale,yScale,myRotation);
draw_text_transformed(tX,tY-1,string_hash_to_newline(text),xScale,yScale,myRotation);
draw_text_transformed(tX-1,tY,string_hash_to_newline(text),xScale,yScale,myRotation);
draw_text_transformed(tX-1,tY+1,string_hash_to_newline(text),xScale,yScale,myRotation);
draw_text_transformed(tX+1,tY-1,string_hash_to_newline(text),xScale,yScale,myRotation);
...
draw_text_transformed(tX,tY,string_hash_to_newline(text),xScale,yScale,myRotation);
