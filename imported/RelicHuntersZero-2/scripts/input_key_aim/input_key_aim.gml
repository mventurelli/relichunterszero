...
{
    if ( mouse_check_button(aimButton1) ) toReturn = true;
}
else
{
    if ( keyboard_check(aimButton1) ) toReturn = true;
}

if (aimButton2 == mb_left) || (aimButton2 == mb_middle) || (aimButton2 == mb_right)
{
    if ( mouse_check_button(aimButton2) ) toReturn = true;
}
else
{
    if ( keyboard_check(aimButton2) ) toReturn = true;
}
