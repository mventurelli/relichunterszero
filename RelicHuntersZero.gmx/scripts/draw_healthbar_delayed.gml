...
//Resolve
if (drawHealthbarDelayOrientation[iD] == "minus")
{
    draw_healthbar(x1,y1,x2,y2, (drawHealthbarDelayedValue[iD]/valueMax)*100, backColor,delayColor,delayColor,dir,showBack,showBorder);
    draw_healthbar(x1,y1,x2,y2, (value/valueMax)*100, backColor,color,color,dir,false,false);
}
else
{
    draw_healthbar(x1,y1,x2,y2, (value/valueMax)*100, backColor,delayColor,delayColor,dir,false,false);
    draw_healthbar(x1,y1,x2,y2, (drawHealthbarDelayedValue[iD]/valueMax)*100, backColor,color,color,dir,showBack,showBorder);
}
